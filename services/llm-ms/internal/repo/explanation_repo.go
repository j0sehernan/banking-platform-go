...
// ExplanationRepo caches explanations generated by the LLM so we don't
// hit Claude every time the front asks for one.
...
// Upsert stores or updates the explanation of a transaction.
...
// GetByTxID reads the explanation of a transaction.
